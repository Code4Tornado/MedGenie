...
function ViewReportDialog({ record }: props) {
  ...
  const renderSymptoms = (symptoms: string | string[] | undefined) => {
    ...
    return <p className="text-gray-950">No symptoms provided.</p>;
  };
  ...
  const renderMedications = (meds: string | string[] | undefined) => {
    ...
    return <p className="text-gray-950">No medications provided.</p>;
  };
  ...
  const renderRecommendations = (recs: string | string[] | undefined) => {
    ...
    return <p className="text-gray-950">No recommendations provided.</p>;
  };
          ...
          <DialogDescription asChild>
            <div className="space-y-2 text-sm">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 space-y-3 space-x-2 text-gray-950">
                  <h2>
                    <span className="font-bold">Doctor Name: </span>{" "}
                    {record.selectedDoctor?.voiceId
                      ? record.selectedDoctor.voiceId.charAt(0).toUpperCase() +
